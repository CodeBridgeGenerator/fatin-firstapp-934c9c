...
const dropdownTemplate2 = (rowData, { rowIndex }) => <p >{rowData.customer}</p>
...
<Column field="customer" header="Customer" body={dropdownTemplate2} filter={selectedFilterFields.includes("customer")} hidden={selectedHideFields?.includes("customer")}  style={{ minWidth: "8rem" }} />
